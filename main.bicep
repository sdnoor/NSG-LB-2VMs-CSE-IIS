...
var nsgName = 'nsg-weu-test'
var nsgRuleName = 'nsgRule'
              ...
              networkSecurityGroup: {
                ...
                properties: {
                  securityRules: [
                    {
                      name: nsgRuleName
                      id: resourceId('Microsoft.Network/networkSecurityGroups/securityRules', nsgName, nsgRuleName)
  ...
  resource nsg 'Microsoft.Network/networkSecurityGroups@2022-05-01' = {
    ...
    properties: {
      ...
      securityRules: [
        {
          id: resourceId('Microsoft.Network/networkSecurityGroups/securityRules', nsgName, nsgRuleName)
          // resourceId('Microsoft.Network/loadBalancers/backendAddressPools', loadBalancerName, 'BackendPool1')
          name: 'nsgRule'
          properties: {
            access: 'Allow'
